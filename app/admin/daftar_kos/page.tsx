  ...
  return (
    <div className="flex flex-col justify-start items-center w-full mb-3">
      ...
      <div className="w-full px-5 flex justify-center">
        <div className="w-full max-w-6xl bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-200">
          {/* Table Header */}
          <div className="grid grid-cols-5 bg-violet-600 font-semibold text-gray-100 text-center">
            <div className="p-3">Nama Kos</div>
            <div className="p-3">No Telepon</div>
            <div className="p-3">Alamat</div>
          ...
          <div className="divide-y divide-gray-200">
            {KosStore.map((k, index) => (
              <div
                key={index}
                className="grid grid-cols-5 text-center hover:bg-gray-50 transition">
                <div className="p-3 text-gray-800">{k.nama_kos}</div>
                <div className="p-3 text-gray-800">{k.notelp}</div>
                ...
                <div className="p-3 text-gray-800">{k.email}</div>
                <div className="p-3">
                  <button
