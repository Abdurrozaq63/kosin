...
export function Sidebar() {
  ...
  const menuItems = [
    { label: 'Rekomendasi', path: '/main', icon: <HiNewspaper /> },
    { label: 'Simpan', path: '/main/simpan', icon: <HiCollection /> },
    { label: 'Riwayat', path: '/main/riwayat', icon: <HiClipboardList /> },
    { label: 'Profil', path: '/main/profil', icon: <HiUserCircle /> },
  ];
